...
namespace ProyectoFinalVeterinaria.Controllers
{
    public class EnfermedadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEnfermedad,nombreEnfermedad,descEnfermedad")] Enfermedades enfermedades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEnfermedad,nombreEnfermedad,descEnfermedad")] Enfermedades enfermedades)
        {
            if (ModelState.IsValid)
            {
