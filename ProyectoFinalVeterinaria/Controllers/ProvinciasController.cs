...
namespace ProyectoFinalVeterinaria.Controllers
{
    public class ProvinciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProvincia,descProvincia")] Provincias provincias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProvincia,descProvincia")] Provincias provincias)
        {
            if (ModelState.IsValid)
            {
